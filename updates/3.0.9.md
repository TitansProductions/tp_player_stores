...
1. Fixed an issue on VORP Framework for buying weapons, for some people it was functional but for some it wasnt due to many framework version updates and changes (Modified by @baguette13
's Developer who fully tested and implemented the new system).
